...
class RegisteredSeller extends Component {
  state = {
    ...this.props.data,
    error: null,
  };
  ...
  onDeactivateHandler = () => {
    axios({
      method: "patch",
      url: `/admin/sellers/deactivate/${this.state.id}`,
      data: {
        isActive: false,
      },
      headers: {
  ...
  onActivateHandler = () => {
    axios({
      method: "patch",
      url: `/admin/sellers/activate/${this.state.id}`,
      data: {
        isActive: true,
      },
      headers: {
            ...
            <form onSubmit={this.handleSubmit} noValidate>
              ...
              <div className={classes.companyContact}>
                ...
                <input
                  ...
                  type="text"
                  name="companyContact"
                  defaultValue={this.state.company_contact}
                  onChange={this.onChangeHandler}
                  disabled
                />
              </div>
...
export default connect(mapStateToProps, null)(RegisteredSeller);
