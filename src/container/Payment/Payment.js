          ...
          <div class="card-body">
            <div class="row">
                    ...
                    <div class="d-block my-3">
                      <div class="mb-2">
                        <input
                          ...
                          required
                        />
                        <label class="form-check-label" for="radioWithGap4">
                          Credit card
                        </label>
                      </div>
                      <div class="mb-2">
                        <input
                          ...
                          required
                        />
                        <label class="form-check-label" for="radioWithGap5">
                          Debit card
                        </label>
                      </div>
                      <div class="mb-2">
                        <input
                          ...
                          required
                        />
                        <label class="form-check-label" for="radioWithGap6">
                          Paypal
                        </label>
                      </div>
                    </div>
              ...
              <div class="col-lg-4 mb-4">
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="mb-4 mt-1 h5 text-center font-weight-bold">
                      Summary
                    </h4>
                    ...
                    <dl class="row">
                      <dd class="col-sm-8">
                        ...
                        people + unlimited projects
                      </dd>
                      <dd class="col-sm-4">$ 2000</dd>
                    </dl>

                    <hr />

                    <dl class="row">
                      <dd class="col-sm-8">Premium support - 2 years</dd>
                      <dd class="col-sm-4">$ 2000</dd>
                    </dl>
                    ...
                    <dl class="row">
                      <dd class="col-sm-8">MDB Membership - 2 years</dd>
                      <dd class="col-sm-4">$ 2000</dd>
                    </dl>
